...
- `DefaultGameEngine.hint` (active-selector hint tool: remove a wrong flag or reveal one safe cell
  in that chunk) is likewise main-safe and chunk-scoped outside `GameAction`.
